 ...
 * /types:
 *   get:
 *     summary: Muestra todas los tipos de libro
 *     tags: [Typebooks]
 *     responses:
 *       200:
 *         description: Lista de tipos de libro
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                     typebooks: object
 *       404:
 *         description: Tipos de libro no encontrados
 */
typeRouter.get('/types', authenticateToken, typeController.showType); 
