 ...
 */
userRouter.post('/user/add', validateUserFields, userController.addUser);
 ...
 *         description: Usuario no encontrado
 */
userRouter.put('/user/:id', authenticateToken, authenticator.authorizePublisher, validateUserFields, userController.modifyUser);
 ...
 *         description: Usuario no encontrado
 */
userRouter.delete('/user/:id', authenticateToken, authenticator.authorizePublisher, userController.deleteUser);
