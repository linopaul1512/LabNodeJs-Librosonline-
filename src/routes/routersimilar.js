 ...
 * /similars:
 *   get:
 *     summary: Muestra todas los productos similares
 *     tags: [Similarproducts]
 *     responses:
 *       200:
 ...
 *                     type: object
 *       404:
 *         description: Productos similares no encontradas
 */
similarRouter.get('/similars', authenticateToken, similarController.showSim); 
