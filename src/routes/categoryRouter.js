 ...
 */
categoryRouter.post('/category/add', authenticateToken, authenticator.authorizePublisher, validateCategoryFields, categoryController.addCategory);
 ...
 *         description: Categoría no encontrada
 */
categoryRouter.put('/category/:id', authenticateToken, authenticator.authorizePublisher, validateCategoryFields, categoryController.modifyCategory);
 ...
 *         description: Categoría no encontrada
 */
categoryRouter.delete('/category/:id', authenticateToken, authenticator.authorizePublisher, categoryController.deleteCategory);
